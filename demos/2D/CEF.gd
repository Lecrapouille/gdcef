...
# ==============================================================================
# Pages generated by load_data_uri() carry their whole content, base64 encoded,
# inside their URL. Displaying such a URL is meaningless for the user.
# ==============================================================================
func displayable_url(url):
...
func _on_page_loaded(http_code, browser):
	...
	var url = displayable_url(browser.get_url())
...
func _on_page_failed_loading(err_code, err_msg, browser):
	$Panel/VBox/BottomBar/Info.set_text("Error " + str(err_code) + ": " + err_msg)
